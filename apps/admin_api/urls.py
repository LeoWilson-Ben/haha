...
urlpatterns = [
    ...
    path("announcements/<int:announcement_id>", views.announcement_get),
    path("announcements/<int:announcement_id>/update", views.announcement_update),
    path("announcements/<int:announcement_id>/status", views.announcement_set_status),
    path("announcements/<int:announcement_id>/delete", views.announcement_delete),
