-- 传统文化 APP 业务库（架构设计.md）
-- 执行前请先创建库：CREATE DATABASE IF NOT EXISTS lingshu DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci; USE lingshu;
